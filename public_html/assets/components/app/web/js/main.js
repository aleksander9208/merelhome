...
jQuery(document).ready(function($){
	...
	$("#post-renovation-service-cost").costCalculator({
		formula: "cleaning-frequency*clean-area+cleaning-frequency*post-renovation-cleaning-supplies+cleaning-frequency*post-renovation-bedrooms*10+cleaning-frequency*post-renovation-bathrooms*20+cleaning-frequency*post-renovation-livingrooms*30+cleaning-frequency*post-renovation-kitchen-size+cleaning-frequency*post-renovation-bathroom-includes+cleaning-frequency*post-renovation-pets+cleaning-frequency*post-renovation-dining-room+cleaning-frequency*post-renovation-play-room+cleaning-frequency*post-renovation-laundry+cleaning-frequency*post-renovation-gym+cleaning-frequency*post-renovation-garage+cleaning-frequency*post-renovation-lustr+cleaning-frequency*post-renovation-refrigerator-clean",
		currency: "Руб.",
		currencyPosition: "before",
		thousandthSeparator: ",",
		decimalSeparator: ".",
	...
	$("#post-renovation-service-cost-2").costCalculator({
		formula: "post-renovation-cleaning-frequency*post-renovation-clean-area+post-renovation-cleaning-frequency*post-renovation-cleaning-supplies+post-renovation-cleaning-frequency*bedrooms*10+post-renovation-cleaning-frequency*bathrooms*20+post-renovation-cleaning-frequency*post-renovation-livingrooms*30+post-renovation-cleaning-frequency*post-renovation-kitchen-size+post-renovation-cleaning-frequency*post-renovation-bathroom-includes+post-renovation-cleaning-frequency*post-renovation-pets+post-renovation-cleaning-frequency*post-renovation-dining-room+post-renovation-cleaning-frequency*post-renovation-play-room+post-renovation-cleaning-frequency*post-renovation-laundry+post-renovation-cleaning-frequency*post-renovation-gym+post-renovation-cleaning-frequency*post-renovation-garage+post-renovation-cleaning-frequency*post-renovation-lustr+post-renovation-cleaning-frequency*post-renovation-refrigerator-clean",
		currency: "Руб.",
		currencyPosition: "before",
		thousandthSeparator: ",",
		decimalSeparator: ".",
	...
	$("#final-service-cost1").costCalculator({
		formula: "cleaning-frequency1*clean-area1+refrigerator1*500+microwave1*350+stove1*500+cabinet1*250+chandelier1*250+radiator1*350+net1*150+dishes1*500+ironing1*500+windows1*135+chair1*200+sofa1*750+carpet1*100",
		currency: "Руб.",
		currencyPosition: "before",
		thousandthSeparator: ",",
		decimalSeparator: ".",
		updateHidden: $("#final-service-cost-hidden1")
	});
	$("#final-service-cost2").costCalculator({
		formula: "cleaning-frequency2*clean-area2+net2*150+dishes2*500+ironing2*500+windows2*135+chair2*200+sofa2*750+carpet2*100",
		currency: "Руб.",
		currencyPosition: "before",
		thousandthSeparator: ",",
		decimalSeparator: ".",
		updateHidden: $("#final-service-cost-hidden2")
	});
	$("#final-service-cost3").costCalculator({
		formula: "cleaning-frequency3*clean-area3+net3*150+dishes3*500+ironing3*500+windows3*135+chair3*200+sofa3*750+carpet3*100",
		currency: "Руб.",
		currencyPosition: "before",
		thousandthSeparator: ",",
		decimalSeparator: ".",
		updateHidden: $("#final-service-cost-hidden3")
	});
